...
//        String[] variables = new String[]{"cgm", "meal", "bolus", "HR", "steps", "calories", "distance", "activityLevel"};
        double atTime = 0;
//        double[] lower = new double[]{40, 0, 0, 50, 0, 0, 0, 1};
//        double[] upper = new double[]{300, 100, 5, 200, 5000, 10, 1, 4};
