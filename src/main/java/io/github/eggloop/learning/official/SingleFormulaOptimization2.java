...
import io.github.eggloop.learning.ComputeAverage;
...
public class SingleFormulaOptimization2 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //import database
        double[] ds2Labels = Utils.readVectorFromFile(FILE_PATH.apply("ST_LIB_DATA/ev_spike/label.txt"));
        double[] ds2Times = Utils.readVectorFromFile(FILE_PATH.apply("ST_LIB_DATA/ev_spike/time.txt"));
        double[][][] ds2SpatialValues = Utils.readMatrixMultiFromFile(ds2Times.length, FILE_PATH.apply("ST_LIB_DATA/ev_spike/traj.txt"));
       ...
       //rise := x_[t+d]-x_[t] > a
        //fall := x_[t]-x_[t+d] > a
//ev_spike := ev_[t_start, t_end-2*d] (x_[t+d]-x_[t] > a and (ev_[0, 2*d]  x_[t]-x_[t+d] > a ))


        //rise and (ev_[0, 2*d] fall)
