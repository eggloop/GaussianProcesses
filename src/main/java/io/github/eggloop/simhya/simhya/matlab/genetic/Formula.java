...
import io.github.eggloop.simhya.simhya.modelchecking.mtl.MTLnode;
import io.github.eggloop.simhya.simhya.modelchecking.mtl.MTLnot;
...
public class Formula {
   ...
   public int getNumberOfAtomicNodes() {
    ...
    public void negate(){
        formula.setNewRoot(new MTLnot(formula.getRoot()));
    }
