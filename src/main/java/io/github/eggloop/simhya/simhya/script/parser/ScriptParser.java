...
package io.github.eggloop.simhya.simhya.script.parser;

import io.github.eggloop.simhya.simhya.GlobalOptions;
import io.github.eggloop.simhya.simhya.dataprocessing.StatType;
...
import io.github.eggloop.simhya.simhya.script.*;
        ...
        while (true) {
            ...
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                case TRUE:
                    ...
                    GlobalOptions.compileMath = true;
                    cmd.printMessage("Option compilemath set to true");
                    break;
                case FALSE:
                    jj_consume_token(FALSE);
                    GlobalOptions.compileMath = false;
                    cmd.printMessage("Option compilemath set to false");
                    break;
                default:
                    jj_la1[3] = jj_gen;
                    jj_consume_token(-1);
                ...
                case SWITCH:
                    ...
                    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                        ...
                        case POPULATION:
                            ...
                            d = Double.parseDouble(t.image);
                            manager.discrete2continuousThreshold = d;
                            jj_consume_token(COMMA);
                            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                                case INTEGER:
                                    t = jj_consume_token(INTEGER);
                            ...
                            d = Double.parseDouble(t.image);
                            manager.continuous2discreteThreshold = d;
                            jj_consume_token(R_CLOSE);
                            break;
                        default:
                            jj_la1[26] = jj_gen;
        ...
        while (true) {
            ...
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                ...
                case FILE:
                    ...
                    jj_consume_token(ASSIGN);
                    t = jj_consume_token(FILENAME);
                    plotter.filename = t.image;
                    plotter.plotToFile = true;
                    break;
                case TRAJECTORY:
                    jj_consume_token(TRAJECTORY);
                    ...
                    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                        case INTEGER:
                            t = jj_consume_token(INTEGER);
                            i = Integer.parseInt(t.image);
                            plotter.singleTrajectory = i;
                            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                                case SEMICOLON:
                                    jj_consume_token(SEMICOLON);
                                    t = jj_consume_token(INTEGER);
                                    j = Integer.parseInt(t.image);
                                    plotter.firstTrajectory = i;
                                    plotter.lastTrajectory = j;
                                    break;
                                default:
                                    jj_la1[63] = jj_gen;
                                    ;
                ...
                case FIX:
                    ...
                    valueLists = new ArrayList<ArrayList<Double>>();
                    ParamValueList(stringList, valueLists);
                    plotter.fixedParams = stringList;
                    plotter.fixedParamsValues = valueLists;
                    break;
                default:
                    jj_la1[67] = jj_gen;
                    jj_consume_token(-1);
        ...
        while (true) {
            ...
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                ...
                case EXPLORE:
                    ...
                    try {
                        manager.setExplore(t1.image, d, d1);
                    } catch (Exception e) {
                        {
                            if (true) throw new ParseException(e.getMessage());
                        }
...
////////////////////////////////////////////////////////////////////////////////////
    ...
    final public void AssignmentList(String modelVar) throws ParseException, NumberFormatException, RuntimeException, ParseException {
        ...
        v = Double.parseDouble(t.image);
        cmd.changeSymbolValue(modelVar, p, v);
        label_19:
        while (true) {
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                case COMMA:
