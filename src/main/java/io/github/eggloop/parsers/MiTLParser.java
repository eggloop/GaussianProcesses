package io.github.eggloop.parsers;
...
public class MiTLParser extends Parser {
	...
	public final eval_return eval(){
		eval_return retval = new eval_return();
	...
	public final exprOR_return exprOR() throws RecognitionException {
		exprOR_return retval = new exprOR_return();
		retval.start = input.LT(1);
	...
	public final exprAND_return exprAND() throws RecognitionException {
		exprAND_return retval = new exprAND_return();
		retval.start = input.LT(1);
	...
	public final mitlTerm_return mitlTerm() throws RecognitionException {
		mitlTerm_return retval = new mitlTerm_return();
		retval.start = input.LT(1);
	...
	public final timeBound_return timeBound() throws RecognitionException {
		timeBound_return retval = new timeBound_return();
		retval.start = input.LT(1);
	...
	public final booelanAtomic_return booelanAtomic() throws RecognitionException {
		booelanAtomic_return retval = new booelanAtomic_return();
		retval.start = input.LT(1);
	...
	public final termExpr_return termExpr() throws RecognitionException {
		termExpr_return retval = new termExpr_return();
		retval.start = input.LT(1);
	...
	public final factorExpr_return factorExpr() throws RecognitionException {
		factorExpr_return retval = new factorExpr_return();
		retval.start = input.LT(1);
	...
	public final functionExpr_return functionExpr() throws RecognitionException {
		functionExpr_return retval = new functionExpr_return();
		retval.start = input.LT(1);
	...
	public final atomic_return atomic() throws RecognitionException {
		atomic_return retval = new atomic_return();
		retval.start = input.LT(1);
