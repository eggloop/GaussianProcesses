...
public class RegressionGP extends AbstractGP<RegressionPosterior> {
	...
	public RegressionGP(Kernel kernel) {
		super(kernel);
	}

	public RegressionGP(IAlgebra algebra, Kernel kernel) {
		super(algebra, kernel);
	}
	...
	private void setupPriorProcess() throws NonPosDefMatrixException {
	...
	public static void main(String[] args) throws NonPosDefMatrixException {
		...
		AbstractGP<RegressionPosterior> gp = new RegressionGP(new RBF());
