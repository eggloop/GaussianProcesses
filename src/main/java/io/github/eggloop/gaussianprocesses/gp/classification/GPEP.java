package io.github.eggloop.gaussianprocesses.gp.classification;
...
public class GPEP extends AbstractGP<ProbitRegressionPosterior> {
	...
	public static void main(String[] args) throws NonPosDefMatrixException {
		...
		// GPEP gp = new GPEP(new RBF(1.1, 0.81));
		GPEP gp = new GPEP(new RBF(2.71, 0.81)); // amplitude 2.71 or 2.7
