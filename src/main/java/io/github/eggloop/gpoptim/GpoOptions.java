...
import io.github.eggloop.sampler.GridSampler;
import io.github.eggloop.sampler.UniformRndSampler;
...
public final class GpoOptions {
	...
	private Kernel kernelGP = new RBF();
	...
	/**
	 * The number of points at which we distance the GP posterior at each step
	 * of the GPO.
	 * 
	 * @see getGridSampler()
	 * @see setGridSampler()
	...
	/**
	 * The grid of points at which we distance the GP posterior at each step of
	 * the GPO.
	 * 
	 ...
	 */
	public void setKernelGP(Kernel kernelGP) {
