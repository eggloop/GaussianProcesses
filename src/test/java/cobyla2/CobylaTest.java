...
import io.github.eggloop.numeric.optimization.cobyla2.Calcfc;
import io.github.eggloop.numeric.optimization.cobyla2.Cobyla;
import io.github.eggloop.numeric.optimization.cobyla2.CobylaExitStatus;
...
public class CobylaTest {
    ...
    public void test01FindMinimum() {
        ...
        assertArrayEquals( new double[]{-1.0, 0.0}, x, 1.0e-5);
    }
    ...
    public void test02FindMinimum() {
        ...
        assertArrayEquals(new double[]{Math.sqrt(0.5), -Math.sqrt(0.5)}, x, 1.0e-5);
    }
    ...
    public void test03FindMinimum() {
        ...
        assertArrayEquals(new double[]{1.0 / Math.sqrt(3.0), 1.0 / Math.sqrt(6.0), -1.0 / 3.0}, x, 1.0e-5);
    }
    ...
    public void test04FindMinimum() {
        ...
        double[] x = {1.0, 1.0};
        CobylaExitStatus result = Cobyla.FindMinimum(calcfc, 2, 0, x, rhobeg, rhoend, iprint, maxfun);
        assertArrayEquals(new double[]{-1.0, 1.0}, x, 1.0e-4);
    }
    ...
    public void test05FindMinimum() {
        ...
        double[] x = {1.0, 1.0};
        CobylaExitStatus result = Cobyla.FindMinimum(calcfc, 2, 0, x, rhobeg, rhoend, iprint, maxfun);
        assertArrayEquals(new double[]{-1.0, 1.0}, x, 3.0e-4);
    }
    ...
    public void test07FindMinimum() {
        ...
        assertArrayEquals(new double[]{0.0, -3.0, -3.0}, x, 1.0e-5);
    }
    ...
    public void test08FindMinimum() {
        ...
        assertArrayEquals(new double[]{0.0, 1.0, 2.0, -1.0}, x, 1.0e-5);
    }
